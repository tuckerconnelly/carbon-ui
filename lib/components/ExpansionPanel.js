...
_labelOpacityAV=new _reactNativeUniversal.Animated.Value(_this.props.expanded?0:1),_this.
_opacityAV=new _reactNativeUniversal.Animated.Value(_this.props.expanded?1:0),_this.
_heightAV=new _reactNativeUniversal.Animated.Value(_this.props.expanded?1:0),_this.
_iconAV=new _reactNativeUniversal.Animated.Value(_this.props.expanded?1:0),_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ExpansionPanel,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(next){var _this2=this;var expanded=this.props.expanded;if(!expanded&&next.expanded){_index.Animations.standard(this._labelOpacityAV,{delay:50,duration:175,toValue:0}).start(function(){return _this2.setState({expanded:true});});_index.Animations.standard(this._opacityAV,{delay:175,duration:300}).start();_index.Animations.standard(this._heightAV).start();setTimeout(function(){return _index.Animations.standard(_this2._iconAV,{duration:150}).start();});}if(expanded&&!next.expanded){_index.Animations.standard(this._heightAV,{delay:50,duration:300,toValue:0}).start();setTimeout(function(){return _index.Animations.standard(_this2._opacityAV,{duration:150,toValue:0}).start(function(){return _this2.setState({expanded:false});});});_index.Animations.standard(this._labelOpacityAV,{delay:150,duration:300,toValue:1}).start();setTimeout(function(){return _index.Animations.standard(_this2._iconAV,{duration:150,toValue:0}).start();});}}},{key:'render',value:function render()
...
var AnimatedIcon=_reactNativeUniversal.Animated.createAnimatedComponent(_index.Icon);
...
return(
_react2.default.createElement(_reactNativeUniversal.Animated.View,{style:(0,_uranium.animate)('marginVertical',0,16,this._heightAV)},
...
_react2.default.createElement(_reactNativeUniversal.View,{style:styles.body},
children),

!!actions&&
_react2.default.createElement(_reactNativeUniversal.View,{style:styles.actions},
...
approximateHeight:_react.PropTypes.number};
