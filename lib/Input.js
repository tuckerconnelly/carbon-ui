...
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Input,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){if(!this.props.value&&nextProps.value){_styles.Animations.standard(this.singleLineLabelAV,1,100).start();}if(this.props.value&&!nextProps.value){_styles.Animations.standard(this.singleLineLabelAV,0,100).start();}}},{key:'render',value:function render()
