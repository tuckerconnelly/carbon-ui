Object.defineProperty(exports,"__esModule",{value:true});exports.Caption=exports.Body1=exports.Body2=exports.Subheading=exports.Title=exports.Headline=exports.Display1=exports.Display2=exports.Display3=exports.Display4=undefined;var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src/components/Type.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.display4,style]},other,{__source:{fileName:_jsxFileName,lineNumber:16}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.display3,style]},other,{__source:{fileName:_jsxFileName,lineNumber:25}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.display2,style]},other,{__source:{fileName:_jsxFileName,lineNumber:34}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.display1,style]},other,{__source:{fileName:_jsxFileName,lineNumber:43}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.headline,style]},other,{__source:{fileName:_jsxFileName,lineNumber:52}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.title,style]},other,{__source:{fileName:_jsxFileName,lineNumber:61}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({css:[theme.type.subheading,css]},other,{__source:{fileName:_jsxFileName,lineNumber:70}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({css:[theme.type.body2,css]},other,{__source:{fileName:_jsxFileName,lineNumber:79}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({css:[theme.type.body1,css]},other,{__source:{fileName:_jsxFileName,lineNumber:88}}),children);
...
return _react2.default.createElement(_reactNative.Text,_extends({style:[theme.type.caption,style]},other,{__source:{fileName:_jsxFileName,lineNumber:97}}),children);
