Object.defineProperty(exports,"__esModule",{value:true});exports.Durations=exports.Curves=undefined;var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _reactNativeUniversal=require('react-native-universal');
...
var Animations={
standard:function standard(av){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return _reactNativeUniversal.Animated.timing(av,_extends({
...
useNativeDriver:options.useNativeDriver&&_reactNativeUniversal.NativeModules.NativeAnimatedModule}));},

large:function large(av){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return _reactNativeUniversal.Animated.timing(av,_extends({
easing:Curves.standard,
toValue:1},
options,{
delay:options.delay&&Durations.custom(options.delay)(),
...
entrance:function entrance(av){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return _reactNativeUniversal.Animated.timing(av,_extends({
...
exit:function exit(av){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return _reactNativeUniversal.Animated.timing(av,_extends({
...
tempExit:function tempExit(av){var options=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return _reactNativeUniversal.Animated.timing(av,_extends({
easing:Curves.sharp,
toValue:1},
options,{
delay:options.delay&&Durations.custom(options.delay)(),
duration:options.duration?Durations.custom(options.duration)():Durations.leaving(),
useNativeDriver:options.useNativeDriver&&_reactNativeUniversal.NativeModules.NativeAnimatedModule}));}};exports.default=
