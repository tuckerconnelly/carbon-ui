...
{var children=_ref.children,disabled=_ref.disabled,flat=_ref.flat,raised=_ref.raised,icon=_ref.icon,theme=_ref.theme,other=_objectWithoutProperties(_ref,['children','disabled','flat','raised','icon','theme']);
