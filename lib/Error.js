...
_createClass(Error,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){if(!this.props.children&&nextProps.children)return this.show(nextProps.children);if(this.props.children&&!nextProps.children)return this.hide();if(this.props.children!==nextProps.children)return this.changeTo(nextProps.children);return null;}},{key:'show',value:function show(text){
...
{var _props=
this.props;var style=_props.style;var other=_objectWithoutProperties(_props,['style']);
