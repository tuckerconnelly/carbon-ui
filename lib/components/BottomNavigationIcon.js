Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src/components/BottomNavigationIcon.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
other,{__source:{fileName:_jsxFileName,lineNumber:35}}),
_react2.default.createElement(_reactNative.Animated.View,{
style:[
styles.base,
(0,_uranium.animate)(styles.base,styles.active,this._activateAV)],__source:{fileName:_jsxFileName,lineNumber:40}},

_react2.default.createElement(AnimatedIcon,{
name:name,
style:(0,_uranium.animate)(styles.icon,styles.iconActive,this._activateAV),__source:{fileName:_jsxFileName,lineNumber:45}}),
_react2.default.createElement(AnimatedBody1,{
style:(0,_uranium.animate)(styles.text,styles.textActive,this._activateAV),__source:{fileName:_jsxFileName,lineNumber:48}},
text))));
