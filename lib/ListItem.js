...
this.props,leftIcon=_props.leftIcon,primaryText=_props.primaryText,active=_props.active,theme=_props.theme;

var tStyles=styles(theme);



var AnimatedTouchableRipple=_reactNativeUniversal.Animated.createAnimatedComponent(_index.TouchableRipple);

return(
_react2.default.createElement(AnimatedTouchableRipple,{
css:[
tStyles.base,
(0,_uranium.animate)(['backgroundColor'],tStyles.base,tStyles.hovered,this._hoverAV)],
