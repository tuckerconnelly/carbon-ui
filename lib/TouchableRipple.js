...
this._container.measure(function(x,y,width,height,pageX,pageY){
_this.position={width:width,height:height,pageX:pageX,pageY:pageY};


_this._container.forceUpdate&&_this._container.forceUpdate();
});
...
this.props,rippleSpread=_props.rippleSpread,rippleOpacity=_props.rippleOpacity,rippleVelocity=_props.rippleVelocity,disabled=_props.disabled;var _position=
this.position,width=_position.width,height=_position.height;
...
scale=newRipple.scale,size=newRipple.size;
...
opacity=ripple.opacity,startTime=ripple.startTime,size=ripple.size;
