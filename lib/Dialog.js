...
_showAV=new _reactNativeUniversal.Animated.Value(_this.props.active?1:0),_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Dialog,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(next){var _this2=this;var active=this.props.active;if(!active&&next.active){this.setState({visible:true});_index.Animations.entrance(this._showAV).start();}if(active&&!next.active){_index.Animations.exit(this._showAV).start(function(){_this2.setState({visible:false});});}}},{key:'render',value:function render()

{var _props=
this.props,title=_props.title,actions=_props.actions,children=_props.children;var
visible=this.state.visible;

if(!visible)return _react2.default.createElement(_reactNativeUniversal.View,null);
...
!!title&&
_react2.default.createElement(_reactNativeUniversal.View,{style:styles.title},_react2.default.createElement(_index.Title,null,title)),

_react2.default.createElement(_reactNativeUniversal.View,{style:[styles.body,!title&&styles.bodyWithoutTitle]},children),
!!actions&&
