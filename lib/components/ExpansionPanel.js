Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/components/ExpansionPanel.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
_react2.default.createElement(_index.Body1,{style:styles.labelText,__source:{fileName:_jsxFileName,lineNumber:50}},label):
label;



return(
_react2.default.createElement(_reactNative.Animated.View,{style:(0,_uranium.animate)('marginVertical',0,16,this._heightAV),__source:{fileName:_jsxFileName,lineNumber:56}},
_react2.default.createElement(_index.Paper,{style:styles.base,__source:{fileName:_jsxFileName,lineNumber:57}},
!expanded&&
_react2.default.createElement(_index.TouchableRipple,{
style:styles.label,
onPress:onExpand,__source:{fileName:_jsxFileName,lineNumber:59}},
_react2.default.createElement(_reactNative.Animated.View,{
style:(0,_uranium.animate)('opacity',0,1,this._labelOpacityAV),__source:{fileName:_jsxFileName,lineNumber:62}},
labelEl)),
...
style:[
styles.icon,
(0,_uranium.animate)(['transform'],styles.icon,styles.iconExpanded,this._iconAV)],__source:{fileName:_jsxFileName,lineNumber:68}}),

_react2.default.createElement(_reactNative.Animated.View,{
style:[
styles.content,
(0,_uranium.animate)('opacity',0,1,this._opacityAV),
(0,_uranium.animate)('maxHeight',0,approximateHeight,this._heightAV)],__source:{fileName:_jsxFileName,lineNumber:74}},

_react2.default.createElement(_reactNative.View,{style:styles.body,__source:{fileName:_jsxFileName,lineNumber:80}},
children),

!!actions&&
_react2.default.createElement(_reactNative.View,{style:styles.actions,__source:{fileName:_jsxFileName,lineNumber:84}},
