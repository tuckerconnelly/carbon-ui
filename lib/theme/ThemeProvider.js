...
ThemeProvider=function(_Component){_inherits(ThemeProvider,_Component);
function ThemeProvider(props,context){_classCallCheck(this,ThemeProvider);var _this=_possibleConstructorReturn(this,(ThemeProvider.__proto__||Object.getPrototypeOf(ThemeProvider)).call(this,
props,context));
_this.theme=props.theme;return _this;
}_createClass(ThemeProvider,[{key:'getChildContext',value:function getChildContext()
...
}}]);return ThemeProvider;}(_react.Component);
...
theme:_light2.default};


ThemeProvider.childContextTypes={
theme:_propTypes2.default.object};exports.default=
