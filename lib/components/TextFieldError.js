...
InputError=function(_Component){_inherits(InputError,_Component);function InputError(){var _ref;var _temp,_this,_ret;_classCallCheck(this,InputError);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=InputError.__proto__||Object.getPrototypeOf(InputError)).call.apply(_ref,[this].concat(args))),_this),_this.
...
this.styles.base,
style,
(0,_uranium.animate)('height',0,estimatedLines*4*_index.gu,this.heightAV),
...
}},{key:'styles',get:function get(){return styles(this.props.theme);}}]);return InputError;}(_react.Component);
...
(0,_index.connectTheme)(InputError);